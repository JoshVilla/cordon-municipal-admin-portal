...
export default function AddCitizenPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch("/api/citizen/addCitizen", {
                method: "POST",
            ...
            showToast.error("Failed to register citizen.");
        } finally {
            setLoading(false);
        }
    };
    return (
        <div className="py-8 px-4 space-y-4">
            <TitlePage title="Register New Citizen" description="Add a new citizen to the system" hasBackButton />
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <CardContent className="pt-6 space-y-4">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        description: "Requires valid PWD ID validation",
                                    },
                                    {
                                        field: "is4PsBeneficiary",
                ...
                <div className="flex justify-end gap-3 pt-2 pb-6">
                    ...
                    <Button type="submit"   disabled={loading}>
                        {loading ? "Registering..." : <><UserPlus className="mr-2 h-4 w-4" />Register Citizen</>}
                    </Button>
                </div>
